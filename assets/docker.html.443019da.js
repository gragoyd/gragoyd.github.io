import{_ as e}from"./plugin-vue_export-helper.21dcd24c.js";import{r as t,o as i,c as d,a as n,b as o,d as a,e as p}from"./app.760fdba4.js";const c={},u=n("h2",{id:"\u6559\u7814\u5BA4\u670D\u52A1\u5668-docker-\u4F7F\u7528\u8BB0\u5F55",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#\u6559\u7814\u5BA4\u670D\u52A1\u5668-docker-\u4F7F\u7528\u8BB0\u5F55","aria-hidden":"true"},"#"),a(" \u6559\u7814\u5BA4\u670D\u52A1\u5668 Docker \u4F7F\u7528\u8BB0\u5F55")],-1),l={href:"https://github.com/gezp/docker-ubuntu-desktop",target:"_blank",rel:"noopener noreferrer"},r=a("\u6208\u632F\u9E4F\u5B66\u957F\u7684 Docker \u5E93"),v=p(`<h2 id="\u8FD0\u884C\u955C\u50CF\u7684\u51C6\u5907\u5DE5\u4F5C" tabindex="-1"><a class="header-anchor" href="#\u8FD0\u884C\u955C\u50CF\u7684\u51C6\u5907\u5DE5\u4F5C" aria-hidden="true">#</a> \u8FD0\u884C\u955C\u50CF\u7684\u51C6\u5907\u5DE5\u4F5C</h2><ol><li>\u53C2\u7167 <a href="#%E7%9B%AE%E5%89%8D%E8%BF%90%E8%A1%8C%E7%9A%84%E9%95%9C%E5%83%8F">\u8FD9\u4E9B</a>\u4EE3\u7801\u8DD1\u8D77\u6765\u3002\u8BB0\u5F97\u5148\u4FEE\u6539\u5176\u4E2D\u7684 <code>--name</code>, <code>-p</code> \u5E76\u786E\u8BA4\u955C\u50CF\u7248\u672C</li><li>\u5728 iTerm2 \u4E2D\u914D\u7F6E profile \u4EE5\u4FBF\u540E\u7EED\u4FBF\u6377\u8FDE\u63A5\u3002\u914D\u7F6E\u5B8C\u540E\u9700\u5C06\u672C\u673A<code>~/.ssh/id_rsa.pub</code>\u7684\u5185\u5BB9\u62F7\u5230 docker \u7684<code>~/.ssh/authorized_keys</code>\u6587\u4EF6\u4E2D\u53BB\uFF0C\u5B9E\u73B0\u65E0\u5BC6\u7801\u767B\u5F55</li><li>NoMachine \u6309\u9700\u914D\u7F6E</li></ol><h2 id="\u76EE\u524D\u8FD0\u884C\u7684\u955C\u50CF" tabindex="-1"><a class="header-anchor" href="#\u76EE\u524D\u8FD0\u884C\u7684\u955C\u50CF" aria-hidden="true">#</a> \u76EE\u524D\u8FD0\u884C\u7684\u955C\u50CF</h2><h3 id="oyd-pytorch3d" tabindex="-1"><a class="header-anchor" href="#oyd-pytorch3d" aria-hidden="true">#</a> oyd_pytorch3d</h3><div class="language-bash ext-sh line-numbers-mode"><pre class="language-bash"><code><span class="token function">docker</span> run -d --restart<span class="token operator">=</span>on-failure <span class="token punctuation">\\</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="oyd-pvnet" tabindex="-1"><a class="header-anchor" href="#oyd-pvnet" aria-hidden="true">#</a> oyd_pvnet</h3><div class="language-bash ext-sh line-numbers-mode"><pre class="language-bash"><code><span class="token function">docker</span> run -d --restart<span class="token operator">=</span>on-failure <span class="token punctuation">\\</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="oyd-ros" tabindex="-1"><a class="header-anchor" href="#oyd-ros" aria-hidden="true">#</a> oyd_ros</h3><div class="language-bash ext-sh line-numbers-mode"><pre class="language-bash"><code><span class="token function">docker</span> run -d --restart<span class="token operator">=</span>on-failure <span class="token punctuation">\\</span>
	...
	gezp/ubuntu-desktop:20.04-cu11.0
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="oyd-ffb6d" tabindex="-1"><a class="header-anchor" href="#oyd-ffb6d" aria-hidden="true">#</a> oyd_ffb6d</h3><div class="language-bash ext-sh line-numbers-mode"><pre class="language-bash"><code><span class="token function">docker</span> run -d --restart<span class="token operator">=</span>on-failure <span class="token punctuation">\\</span>
	...
	gezp/ubuntu-desktop:18.04-cu10.1
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="oyd-ffb6d-new" tabindex="-1"><a class="header-anchor" href="#oyd-ffb6d-new" aria-hidden="true">#</a> oyd_ffb6d_new</h3><div class="language-bash ext-sh line-numbers-mode"><pre class="language-bash"><code><span class="token function">docker</span> run -d --restart<span class="token operator">=</span>on-failure <span class="token punctuation">\\</span>
	...
	gezp/ubuntu-desktop:20.04-cu11.0
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,13);function m(b,k){const s=t("ExternalLinkIcon");return i(),d("div",null,[u,n("blockquote",null,[n("p",null,[n("a",l,[r,o(s)])])]),v])}var g=e(c,[["render",m],["__file","docker.html.vue"]]);export{g as default};
